...
class testStudent(unittest.TestCase):
    ...
    * Call a method named apply_extension that will take a number of days as an argument on the student instamce to update the end_date
    ...
    * Run the tests to confirm that the new method is now failing
    ...
    * Run the test to confirm they are working.
    """
